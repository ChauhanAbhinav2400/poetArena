...
export async function generateMetadata({params}) {
  ...
  return {
    title: params.poetryId,
    description: metaData?.metaDescription,
    openGraph: {
      title: metaData?.metaTitle,
      description: metaData?.metaDescription,
      url: `${metaData?.websiteUrl}${metaData?.pageUrl}/${params.poetryId.split(" ").join("-")}`,
    ...
    alternates: {
      canonical: `${metaData?.websiteUrl}${metaData?.pageUrl}/${params.poetryId.split(" ").join("-")}`,
    },
  };
}
