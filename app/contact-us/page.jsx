...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiCall({
        method: "POST",
        url: `${BASE_URL}${API_ENDPOINTS.CONTACT_US}`, // Use the CONTACT_US endpoint
        body: formData,
      });
  ...
  return (
    <div className="min-h-screen mt-20 bg-gray-700 py-12 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto px-4 text-white">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            We'd love to hear from you. Feel free to reach out with questions,
            feedback, or partnership inquiries for Shayri मंच.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
            ...
            <p className="mb-6 text-gray-300">
              Connect with Shayri मंच team for any queries or suggestions. We
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">contact@shayrimanch.com</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="text-pink-500 mr-4 mt-1">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    } rounded-md py-2 px-3 focus:outline-none focus:border-purple-500`}
                  />
                  {errors.name && (
                ...
                <div className="mt-6">
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-purple-700 to-pink-600 text-white font-medium py-2 px-4 rounded-md hover:opacity-90 transition focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50"
                  >
                    Send Message
                  </button>
                </div>
